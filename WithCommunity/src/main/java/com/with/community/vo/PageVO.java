...
public class PageVO {
	...
	public String toString() {
		return "PageVO [pageIndex=" + pageIndex + ", pageUnit=" + pageUnit + ", pageSize=" + pageSize + ", firstIndex="
				+ firstIndex + ", recordCountPerPage=" + recordCountPerPage + ", totCnt=" + totCnt + ", startDate="
				+ startDate + ", endDate=" + endDate + ", realEnd=" + realEnd + ", prev=" + prev + ", next=" + next
				+ "]";
	}
